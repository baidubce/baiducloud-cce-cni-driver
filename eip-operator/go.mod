module github.com/baidubce/baiducloud-cce-cni-driver/cce-network-ext-eip

go 1.18

replace github.com/baidubce/baiducloud-cce-cni-driver/cce-network-v2 => ../cce-network-v2
