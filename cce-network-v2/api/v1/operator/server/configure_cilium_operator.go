...
//go:generate swagger generate server --target ../../operator --name CCEOperator --spec ../openapi.yaml --api-package restapi --server-package server --principal interface{}

func configureFlags(api *restapi.CCEOperatorAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *restapi.CCEOperatorAPI) http.Handler {
