...
type SubnetAllocation struct {
	IPAllocationStrategy `json:",inline"`

	IPv4 []string `json:"ipv4,omitempty"`
	IPv6 []string `json:"ipv6,omitempty"`
	// IPv4Range CIDR list for IPv4 address to allocated to pod
	IPv4Range []string `json:"ipv4Range,omitempty"`
	// IPv6Range CIDR list for IPv6 address to allocated to pod
	IPv6Range []string `json:"ipv6Range,omitempty"`

	// Custom When the Type field is `custom`, other sub attributes (such as `IPv4``, `IPv4Range``, etc.)
	// of SubnetAllocation will be ignored. At this time, the management policy
	// of IP address is taken over by Custom
	//
	// If the Type is Elastic, Fixed or Manual, the internal part of the Custom field will not be resolved
	// The Custom type is not universal, because it may cause IP address disclosure
...
type CustomAllocation struct {
	...
	Family k8sutilnet.IPFamily `json:"family,omitempty"`
	...
	CustomIPRange []CustomIPRange `json:"customIPRange,omitempty"`
}
...
// +kubebuilder:validation:Enum=Elastic;Fixed;Manual;Custom;IPAllocTypeNil
...
const (
	...
	IPAllocTypeCustom  IPAllocType = "Custom"
)
