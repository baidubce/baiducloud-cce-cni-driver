...
import (
	...
	"github.com/baidubce/baiducloud-cce-cni-driver/cce-network-v2/cmd/webhook/webhookcontroller/generator"
...
func certToProjectionMap(cert *generator.Artifacts) map[string]FileProjection {
