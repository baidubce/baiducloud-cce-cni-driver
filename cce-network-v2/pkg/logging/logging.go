...
var (
	...
	NewContext    = logfields.NewContext
)
...
func init() {
	...
	klogFlags := flag.NewFlagSet("cce-network-v2", flag.ExitOnError)
...
func InitializeDefaultLogger() (logger *logrus.Logger) {
	...
	logger.Hooks.Add(&hooks.ContextHook{})
	return
}

func NewSubysLogger(subsys string) *logrus.Entry {
...
// GetLogFile returns the location of the log file for this instance.
