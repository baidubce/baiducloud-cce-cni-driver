...
// PodSubnetTopologySpreadsGetter has a method to return a PodSubnetTopologySpreadInterface.
...
// podSubnetTopologySpreads implements PodSubnetTopologySpreadInterface
type podSubnetTopologySpreads struct {
	client rest.Interface
	ns     string
}

// newPodSubnetTopologySpreads returns a PodSubnetTopologySpreads
func newPodSubnetTopologySpreads(c *CceV2Client, namespace string) *podSubnetTopologySpreads {
	return &podSubnetTopologySpreads{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *podSubnetTopologySpreads) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.PodSubnetTopologySpread, err error) {
	result = &v2.PodSubnetTopologySpread{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *podSubnetTopologySpreads) List(ctx context.Context, opts v1.ListOptions) (result *v2.PodSubnetTopologySpreadList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2.PodSubnetTopologySpreadList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("podsubnettopologyspreads").
...
func (c *podSubnetTopologySpreads) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *podSubnetTopologySpreads) Create(ctx context.Context, podSubnetTopologySpread *v2.PodSubnetTopologySpread, opts v1.CreateOptions) (result *v2.PodSubnetTopologySpread, err error) {
	result = &v2.PodSubnetTopologySpread{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podsubnettopologyspreads").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(podSubnetTopologySpread).
		Do(ctx).
		Into(result)
	return
}
...
func (c *podSubnetTopologySpreads) Update(ctx context.Context, podSubnetTopologySpread *v2.PodSubnetTopologySpread, opts v1.UpdateOptions) (result *v2.PodSubnetTopologySpread, err error) {
	result = &v2.PodSubnetTopologySpread{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podsubnettopologyspreads").
		Name(podSubnetTopologySpread.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(podSubnetTopologySpread).
		Do(ctx).
		Into(result)
...
func (c *podSubnetTopologySpreads) UpdateStatus(ctx context.Context, podSubnetTopologySpread *v2.PodSubnetTopologySpread, opts v1.UpdateOptions) (result *v2.PodSubnetTopologySpread, err error) {
	result = &v2.PodSubnetTopologySpread{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podsubnettopologyspreads").
...
func (c *podSubnetTopologySpreads) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *podSubnetTopologySpreads) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *podSubnetTopologySpreads) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.PodSubnetTopologySpread, err error) {
	result = &v2.PodSubnetTopologySpread{}
