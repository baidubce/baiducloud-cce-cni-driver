...
func (k *K8sIntegrationSuite) SetUpSuite(c *C) {
	if os.Getenv("INTEGRATION") != "" {
		if k8sConfigPath := os.Getenv("KUBECONFIG"); k8sConfigPath == "" {
			k8s.Configure("", "/var/lib/cce/cce.kubeconfig", defaults.K8sClientQPSLimit, defaults.K8sClientBurst)
		} else {
...
var nodeSampleJSON = `{
    ...
    "metadata": {
        "annotations": {
            ...
            "io.cce.network.ipv4-cce-host": "10.0.0.1",
            "io.cce.network.ipv4-health-ip": "10.0.0.1",
            "io.cce.network.ipv4-pod-cidr": "10.0.0.1/27",
    ...
    "status": {
        ...
        "images": [
            {
                "names": [
                    "quay.io/cce/cce-dev@sha256:53e005e8ae3649412cfb5b5538916bc6c9f66c408ee6a76273e964a285cb28aa",
                    "quay.io/cce/cce-dev:scale-test-2019-03-13"
                ],
                "sizeBytes": 618888533
            },
            {
                "names": [
                    "quay.io/cce/cce@sha256:9f41fc120b2c8cf5006220bcea7ee17c573cb13f0d32b0578ea83690f6412b6e",
                    "quay.io/cce/cce:latest"
                ],
                "sizeBytes": 618884013
            },
            {
                "names": [
                    "quay.io/cce/cce-dev@sha256:41b2bc225d90a52cbf04f030fd4e4bb8235e00262e08643963dd887090d17b96",
                    "quay.io/cce/cce-dev:scale-test-2019-03-12"
                ],
                "sizeBytes": 618855547
            },
            {
                "names": [
                    "cce/cce@sha256:bb8a0507c1850f856d7c3e1ab27fa8246d666dcf5bab9040ced3d6513e730b02",
                    "cce/cce:latest"
                ],
                "sizeBytes": 618841491
            },
            {
                "names": [
                    "cce/cce@sha256:2d0ea8c2eee882c7005d5645f349f58bca57fcd8e2e682a517c400ccd045f9c2"
                ],
                "sizeBytes": 618821939
            },
            {
                "names": [
                    "cce/cce-dev@sha256:c55141a813d30123c34372b87d75c3b8ff4eaf955ff0531f93ec2a8fbd2d6dff",
                    "cce/cce-dev:tgraf-scale-fixes2"
                ],
                "sizeBytes": 618670939
            },
            {
            ...
            {
                "names": [
                    "quay.io/cce/cce-dev@sha256:d8bb81b46f9e10e40ca106bc6a9ac0f3365e5310bbb5bfba1f52d1d8c8b64740",
                    "quay.io/cce/cce-dev:vetcd-v3.3.11-hf1-aanm"
                ],
                "sizeBytes": 64108258
            },
            {
            ...
            {
                "names": [
                    "quay.io/cce/operator-dev@sha256:ab697ec83f8e3da7e64630c67252a5cf2ac4017ce2414c6c1d5476e165a844c6",
                    "quay.io/cce/operator-dev:scale-test-2019-03-12"
                ],
                "sizeBytes": 48754920
            }
        ],
...
func OldEqualV1Node(node1, node2 *v1.Node) bool {
	...
	// particularly the CCEHostIP annotation.
	return node1.GetObjectMeta().GetName() == node2.GetObjectMeta().GetName() &&
		node1.GetAnnotations()[annotation.CCEHostIP] == node2.GetAnnotations()[annotation.CCEHostIP]
}
