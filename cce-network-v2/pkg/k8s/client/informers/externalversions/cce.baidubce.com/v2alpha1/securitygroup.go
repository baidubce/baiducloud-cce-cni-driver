...
func NewFilteredSecurityGroupInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&ccebaidubcecomv2alpha1.SecurityGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *securityGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ccebaidubcecomv2alpha1.SecurityGroup{}, f.defaultInformer)
}

func (f *securityGroupInformer) Lister() v2alpha1.SecurityGroupLister {
	return v2alpha1.NewSecurityGroupLister(f.Informer().GetIndexer())
}
