...
// NewForConfigAndClient creates a new CceV2alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CceV2alpha1Client, error) {
	...
	return &CceV2alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CceV2alpha1Client for the given config and
