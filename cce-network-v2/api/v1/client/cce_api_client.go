...
import (
	...
	"github.com/baidubce/baiducloud-cce-cni-driver/cce-network-v2/api/v1/client/daemon"
...
// NewHTTPClient creates a new cce API HTTP client.
func NewHTTPClient(formats strfmt.Registry) *CceAPI {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new cce API HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *CceAPI {
...
// New creates a new cce API client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *CceAPI {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *CceAPI) SetTransport(transport runtime.ClientTransport) {
