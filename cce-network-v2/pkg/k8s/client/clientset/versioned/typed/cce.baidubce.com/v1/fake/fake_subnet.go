...
import (
	...
	ccebaidubcecomv1 "github.com/baidubce/baiducloud-cce-cni-driver/cce-network-v2/pkg/k8s/apis/cce.baidubce.com/v1"
...
var subnetsResource = schema.GroupVersionResource{Group: "cce.baidubce.com", Version: "v1", Resource: "subnets"}

var subnetsKind = schema.GroupVersionKind{Group: "cce.baidubce.com", Version: "v1", Kind: "Subnet"}
...
func (c *FakeSubnets) Get(ctx context.Context, name string, options v1.GetOptions) (result *ccebaidubcecomv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(subnetsResource, name), &ccebaidubcecomv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*ccebaidubcecomv1.Subnet), err
}
...
func (c *FakeSubnets) List(ctx context.Context, opts v1.ListOptions) (result *ccebaidubcecomv1.SubnetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(subnetsResource, subnetsKind, opts), &ccebaidubcecomv1.SubnetList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &ccebaidubcecomv1.SubnetList{ListMeta: obj.(*ccebaidubcecomv1.SubnetList).ListMeta}
	for _, item := range obj.(*ccebaidubcecomv1.SubnetList).Items {
...
func (c *FakeSubnets) Create(ctx context.Context, subnet *ccebaidubcecomv1.Subnet, opts v1.CreateOptions) (result *ccebaidubcecomv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(subnetsResource, subnet), &ccebaidubcecomv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*ccebaidubcecomv1.Subnet), err
...
func (c *FakeSubnets) Update(ctx context.Context, subnet *ccebaidubcecomv1.Subnet, opts v1.UpdateOptions) (result *ccebaidubcecomv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(subnetsResource, subnet), &ccebaidubcecomv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*ccebaidubcecomv1.Subnet), err
...
func (c *FakeSubnets) UpdateStatus(ctx context.Context, subnet *ccebaidubcecomv1.Subnet, opts v1.UpdateOptions) (*ccebaidubcecomv1.Subnet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(subnetsResource, "status", subnet), &ccebaidubcecomv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*ccebaidubcecomv1.Subnet), err
...
func (c *FakeSubnets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(subnetsResource, name, opts), &ccebaidubcecomv1.Subnet{})
	return err
}
...
func (c *FakeSubnets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &ccebaidubcecomv1.SubnetList{})
	return err
}
...
func (c *FakeSubnets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *ccebaidubcecomv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(subnetsResource, name, pt, data, subresources...), &ccebaidubcecomv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*ccebaidubcecomv1.Subnet), err
