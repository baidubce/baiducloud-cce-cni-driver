...
// this method is diffrent from the original cni ipam in ipam_linux.go
// it will not set the ip address to the interface and will set the default gateway to the interface onlink
func CPTPConfigureIface(ifName string, res *current.Result) error {
	...
	for _, ipc := range res.IPs {
		...
		var netMask = net.CIDRMask(32, 32)
